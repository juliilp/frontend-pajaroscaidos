...
export default function CardForo({ titulo, tiempo, user, like, message, image }) {
  return (
      ...
      <div className="w-4/6 h-[100px] flex flex-col px-3 gap-1 justify-center font-inter ">
        ...
        <div className="flex gap-6 self-end sm:self-start pr-6">
          <div className="flex gap-2 ">
            <IoMdHeartEmpty color="#E11447" size={25} className="cursor-pointer" />
            <span className="text-[#AA153A] font-semibold text-lg ">{like}</span>
          </div>
          <div className="flex  gap-2">
