...
const IconsReactionsMobile = ({ id, commentsQuantity, reactions }) => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex items-center direction:row mt-2 p-1 ">
        <RiMessage2Line color="#0C6410" size={18} />
        <span className="text-[#0C6410] font-semibold text-lg ml-1">{commentsQuantity}</span>
      </div>
    </>
  );
};

export default IconsReactionsMobile;
