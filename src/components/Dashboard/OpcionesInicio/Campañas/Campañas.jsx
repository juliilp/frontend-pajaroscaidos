  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center rounded-xl mt-[10px] h-[450px] w-[90%] bg-[#444] mb-10">
        ...
        <div className="flex justify-end w-[95%] md:w-[95%] mb-5">
          <div className="flex justify-center items-center px-2 md:w-[30%] w-[55%] text-sm h-8 bg-[#60EA4A] font-bold rounded">
