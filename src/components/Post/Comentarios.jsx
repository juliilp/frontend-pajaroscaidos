...
export default function Comentarios({ comments}) {
    ...
    return (
        <div className="w-full  h-full text-lettersgray flex flex-col items-center gap-3">
            ...
            <section className="flex flex-col items-center w-full gap-4 sm:gap-0
            sm:flex-row  sm:items-stretch  sm:justify-between   sm:w-[95%] ">
                ...
                <article className="flex w-full sm:w-fit justify-start items-end sm:items-center min-h-[3rem] sm:min-h-[3rem]">
                    <h3 className=" text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-semibold">Comentarios</h3>
                </article>

                <article className="flex items-center  min-h-[3rem]  justify-between w-full min-w-fit  max-w-full  
            ...
            {comments.length?<div className=" w-[95%] flex flex-col gap-5 ">
                {comments?.map((i,key) =>
                    <section className="flex flex-col  gap-4 items-start" key={key}>
                        ...
                        <article title="coment" className=" font-semibold w-full sm:w-8/12">
                        ...
                        <div className={`  m-auto w-full sm:w-11/12 md:w-10/12 bg-[#c2c2c2] h-[0.1rem]  border-2 border-lightgray rounded-lg  `} style={{ filter: ' drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.23))' }} />

                    </section>
                )
                }
            </div>:  <div><h1>Sin comentarios</h1></div>
