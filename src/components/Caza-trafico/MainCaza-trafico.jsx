  ...
  return (
    <>
      <div className="flex w-full justify-end">
        <button className="text-sm min-[350px]:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl text-white bg-green p-2 md:p-3 hover:text-gray-100 hover:bg-[#13b113] duration-200">
          Como denunciar
        </button>
      </div>
