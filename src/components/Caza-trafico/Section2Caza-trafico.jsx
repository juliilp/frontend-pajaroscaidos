        ...
        <>
            <article className="flex flex-col w-[95%] md:w-[48%] gap-8">
                ...
                <p>En diciembre de 2018, la Asociación Civil de Ayuda a las Aves Pájaros Caídos recibió un pichón
                    ...
                    ser devuelto a la naturaleza. La Asociación puso en marcha un operativo que que recorrió por
                    tierra mas de 1300 kilómetros para devolver a la selva el pichón de tucán que había sido
                    comprado en la Ciudad de Buenos Aires, víctima del tráfico ilegal de fauna.
                </p>
            </article>
