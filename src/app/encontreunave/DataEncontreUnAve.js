...
export const DataEncontreUnAve = [
  ...
  },
  {
    ...
    imagen: Imagen2,
    parrafo:
      "El Refugio de Aves Pájaros Caídos es una Grupo de Facebook donde puedes hacer tu consulta, enviando una foto y describiendo el tipo de ave que has rescatado. Alli deberás informar el estado en que se encuentra y un grupo de voluntarios especializados te indicarán cuales son los primeros auxilios y cuidados de emergencia que debes adoptar, o bien indicarte si requiere atención veterinaria urgente.Desde el grupo de Facebook Consultas Refugio de Aves Pájaros Caidos te indicarán como alimentarlas, cuidarlas o bien reinsertarlas en su hábitat natural. Es un servicio gratuito..MUY IMPORTANTE: Para realizar la consulta sobre aves, o recibir asistencia en casos de URGENCIA, accede al enlace que tenes a continuación y escribí tu pregunta, que te responderemos a la mayor brevedad posible.",
    video: false,
    blog: false,
  },
  {
    ...
    imagen: Imagen3,
    parrafo:
      "En el Blog de Pájaros Caídos podrás encontar información de importancia como tutoriales, videos y explicaciones de como cuidar mejor a las aves, desde alimentar un pichón a dieta que debe `proporcionarsele, asi como primeros auxilios, enfermedades comunes, entre otras cosas.Cualquier duda que tengas luego de visitar el Blog, podrás consularla en el Grupo de Facebook del Refugio de Aves Pájaros Caidos.",
    video: false,
    blog: true,
  },
  {
