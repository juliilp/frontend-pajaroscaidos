...
export default function page() {
  return (
    <div className="font-semibold min-h-screen flex flex-col items-center gap-12 lg:text-lg xl:text-xl pt-[70px] 2xl:text-2xl">
      <section className="h-[18rem] 2xl:h-[23rem] bg-black relative w-full">
        <Image src={image1} alt="Image1" fill />
      </section>

      <main className="flex items-center flex-col w-full text-center gap-12">
        <MainAboutSection />
      </main>
