...
export default function page() {
  return (
    <div
      className={`${font.baloo} font-semibold flex flex-col items-center gap-12 pt-[69px] pb-[5rem]`}
    >
      <div className="w-full relative h-[8rem] min-[320px]:h-[9rem] min-[400px]:h-[10rem] min-[500px]:h-[12rem] sm:h-[13rem]  md:h-[14rem] lg:h-[15rem] 2xl:h-[17rem]">
        <Image
          src="https://res.cloudinary.com/di5mf85h3/image/upload/v1694208691/legislacion_1_abyywl.png"
          alt="background"
          width={1747}
          height={475}
          priority={true}
