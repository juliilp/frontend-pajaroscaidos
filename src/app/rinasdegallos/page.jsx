    ...
    <section className="mt-[70px] w-full bg-[#d8d8d8] h-full pb-16">
      ...
      <div className="w-full flex flex-col lg:grid lg:grid-cols-6 mb-12 pt-6">
        <p className="px-6 max-w-[800px] text-lg col-span-4 lg:mx-auto lg:px-0 pr-6">
          ...
          muertes de los gallos serían destinadas a entidades protectoras de
          animales. <br />
          ...
          instituciones. Los actos de crueldad hacia los gallos que permite esta
          ley demuestran que el hombre puntano ha retrocedido en el tiempo,
          ...
          violan expresamente el principio de supremacía de las normas
          consagrado por el artículo 31 de la Constitución Nacional que
          establece que las leyes de la Nación que en su consecuencia se dicten
          por el Congreso son la ley suprema de la Nación; y las autoridades de
          cada provincia están obligadas a conformarse a ella, en tanto que el
          artículo 126 indica que los Estados provinciales no pueden dictar
          leyes de fondo como el código penal. El sistema constitucional federal
          sobre el que está organizada la República Argentina es claro y
          categórico: la legislación de fondo, delegada por las provincias, es
          atribución exclusiva del Congreso Nacional. <br />
          En la actualidad, la única provincia que autoriza la riña de gallos es
          Santiago del Estero a través de la Ley provincial N° 5574,[8] en
      ...
      <div className="bg-[#C2C2C2] mx-6 max-w-[950px] lg:mx-auto ">
        ...
        <p className="px-6">
          ...
          reformada de 1994: “Dictar los Dictar los Códigos Civil, Comercial,
          Penal, de Minería, y del Trabajo y Seguridad Social…” <br />
          [2] Asociación Animalista Libera Tucumán.
          <br />
          [3] “Acevedo Ivana y otros c/ Provincia de Tucumán s/ acción
          Declarativa de Inconstitucionalidad”, Expediente n° 108/2016, Cámara
          Contencioso Administrativa, Sala II, Sentencia N° 774.
          <br />
          [4] Ley N° V-0546-2006 - SAN LUIS, 20 de Diciembre de 2006 - Boletín
          Oficial, 1 de Enero de 2007, Artículo 1.
          <br />
          [5] Ibídem, Artículo 4<br />
          [6] Asociación Civil Samayhuasi.
          <br />
          [7] Asociación Civil Samayhuasi c/ Estado Provincial –Demanda de
          Inconstitucionalidad”, Expediente Nº 06-A-07.- STJSL-S.J. Nº 727 /09,
